...
{
    public class DriveBViewModel : ObservableObject
    {
        private bool _isLeft, _isRight;
        private double _speed;
        private string _inputSpeed = "0";

        public PackIconKind ArrowKind => IsLeft ? PackIconKind.ArrowLeftBold :
                                             IsRight ? PackIconKind.ArrowRightBold :
                                             PackIconKind.ArrowRightBold;
        ...
        private DriversPortEnum _driverPort = DriversPortEnum.One;
        private int _driverChannel = 1;
        private DriverModule _driverModule;
        public DriveBViewModel()
        {
